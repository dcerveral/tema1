<!-- /portfolio section --><div class="enigma_blog_area ">
	...
	<div class="row">
		<div class="col-lg-6 col-xs-12">
				...
				<iframe class="embed-responsive-item"  scrolling="no" src="https://maps.google.com/maps?q=<? echo htmlentities ($seccion['array']); ?>&amp;num=1&amp;t=m&amp;ie=UTF8&amp;z=14&amp;output=embed" frameborder="0"  ></iframe>
				</div>
